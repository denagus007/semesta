package co.id.app.geisa.security.oauth2;

import co.id.app.geisa.config.oauth2.OAuth2Properties;
import co.id.app.geisa.web.filter.RefreshTokenFilter;
import co.id.app.geisa.web.rest.errors.InvalidPasswordException;
...
public class OAuth2AuthenticationServiceTest {
    ...
    public void init() {
        ...
        jHipsterProperties.getSecurity().getClientAuthorization().setAccessTokenUri("http://aisa/oauth/token");
    ...
    private void mockInvalidPassword() {
        ...
        when(restTemplate.postForEntity("http://aisa/oauth/token", entity, OAuth2AccessToken.class))
