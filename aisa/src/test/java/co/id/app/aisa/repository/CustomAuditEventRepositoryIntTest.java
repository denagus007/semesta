...
import co.id.app.aisa.config.audit.AuditEventConverter;
import co.id.app.aisa.domain.PersistentAuditEvent;
...
import static co.id.app.aisa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
