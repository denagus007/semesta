...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName(serviceId);
        ...
        config.getMapConfigs().put("co.id.app.aisa.domain.*", initializeDomainMapConfig(jHipsterProperties));
